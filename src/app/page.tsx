...
export default function Home() {
  ...
  return (
    <main
      id="shortly-app"
      className="min-svh relative mx-auto flex h-dvh max-h-screen w-full max-w-4xl items-center justify-center bg-neutral-100 text-neutral-900 dark:bg-neutral-950 dark:text-neutral-100"
    >
      <Card>
        <Form />
      </Card>
